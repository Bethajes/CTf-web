    ...
    <section className="bg-slate-50 py-20 dark:bg-black">
      <div className="section-shell grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          ...
          <h1 className="mt-4 text-4xl font-black text-slate-900 dark:text-white sm:text-6xl">Map your next software platform with CTF</h1>
          ...
          <div className="mt-8 grid gap-4">
            {[
              ...
              <div key={String(label)} className="flex items-center gap-3 font-semibold text-slate-800 dark:text-white">
                {/* @ts-ignore */}
