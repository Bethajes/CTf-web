    ...
    <>
      <section className="bg-white py-20 dark:bg-slate-950">
        <div className="section-shell max-w-4xl text-center">
          ...
          <h1 className="mt-4 text-4xl font-black text-slate-900 dark:text-white sm:text-6xl">Built to engineer the future through software</h1>
      ...
      <AnimatedSection className="bg-slate-50 py-20 dark:bg-slate-900">
