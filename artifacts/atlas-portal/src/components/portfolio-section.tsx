...
function FeaturedProjectCard({
  ...
  return (
    <motion.div
      ...
      className="overflow-hidden rounded-xl border border-slate-200 bg-white dark:border-white/10 dark:bg-black"
    >
      <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="relative grid place-items-center border-t border-slate-200 bg-slate-50 p-6 lg:border-t-0 lg:border-l dark:border-white/10 dark:bg-white/[0.02]">
          <div className="relative w-full max-w-md">
            <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-lg dark:border-white/10 dark:bg-neutral-950">
...
function SolutionCard({
  ...
  return (
    <motion.article
      ...
      className="group rounded-lg border border-slate-200 bg-white p-5 transition hover:-translate-y-1 hover:border-cyan-400/40 dark:border-white/10 dark:bg-white/[0.03] dark:hover:border-cyan-300/30"
    >
      <div className="mb-4 flex items-center justify-between">
        <div className="grid h-10 w-10 place-items-center rounded-md bg-cyan-50 text-cyan-700 dark:bg-cyan-400/10 dark:text-cyan-200">
          <Icon className="h-5 w-5" />
        </div>
        <span className="rounded-md border border-slate-200 bg-slate-50 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-slate-500 dark:border-white/10 dark:bg-white/[0.04] dark:text-slate-400">
          {solution.status}
        </span>
      </div>
      ...
      <div className="mt-3 flex flex-wrap gap-1.5">
        {solution.features.map((f) => (
          <span key={f} className="rounded-md border border-slate-200 bg-slate-50 px-1.5 py-0.5 text-[10px] text-slate-500 dark:border-white/10 dark:bg-white/[0.04] dark:text-slate-300">
            {f}
          </span>
        ))}
      </div>
